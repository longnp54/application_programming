...
namespace application_programming.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=" + Application.StartupPath + @"\Quanlybanhang.mdf;Integrated Security=True;Connect Timeout=30";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
