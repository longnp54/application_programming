    ...
    public partial class frmTimHDBan : Form
    {
        ...
        private void dgvTKHoaDon_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn hiển thị thông tin chi tiết?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                if (dgvTKHoaDon.CurrentRow != null && dgvTKHoaDon.CurrentRow.Cells["MaHDBan"] != null)
                {
                    mahd = dgvTKHoaDon.CurrentRow.Cells["MaHDBan"].Value?.ToString();
                    // Rest of your code
                ...
                {
                    MessageBox.Show("Sai rồi", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                }
